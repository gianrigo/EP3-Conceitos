...
datatype Expressao =
  Valor of valor
| Id of Id
| ExpBool of (Expressao * string * Expressao)
...
(* TESTES *)
val e1 = ExpAritm(Valor(ValorInteiro 300), "+", Valor(ValorInteiro 12));
val e2 = ExpAritm(Valor(ValorInteiro 300), "-", Valor(ValorInteiro 12));
val e3 = ExpBool(Valor(ValorBooleano true), "And", Valor(ValorBooleano false));
val e4 = ExpBool(Valor(ValorBooleano true), "Or", Valor(ValorBooleano false));
val e5 = ExpBool(Valor(ValorBooleano true), "==", Valor(ValorBooleano false));
